...
nb0 = 20000.0
np0 = 150.0
#insert1='./QEDb'+str(int(nb0))+'p'+str(int(np0))+'/'
insert1='./Data/'
print(insert1)
...
y_max0=(py_0/alpha_0)**0.5
y_max=((py_0-(radt-radpx))/alpha_0)**0.5/2.0/np.pi
...
fig.savefig(to_path+'png_a200_b002_p150.png',format='png',dpi=160)
plt.close("all")
