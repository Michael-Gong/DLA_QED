...
if __name__ == "__main__":
  ...
  width = 100
  kwargs = dict(histtype='stepfilled', alpha=0.4, normed=None, color='r', bins=100, range=(0,1500), weights=ww0,label='w/o  RR')
  plt.hist(gg0, **kwargs)
  kwargs = dict(histtype='stepfilled', alpha=0.4, normed=None, color='b', bins=100, range=(0,1500), weights=ww2,label='with RR')
  plt.hist(gg2, **kwargs)
...
#  plt.xscale('log')
  plt.xlim(0,1500)
  plt.ylim(10,1e7)
  plt.legend(loc='best',fontsize=28,framealpha=0.5)
...
#  plt.title('t='+str(round(t1[0,i],0))+' $T_0$',fontdict=font)
  ...
  fig.savefig('ph_dN_dE_500.png',format='png',dpi=160)
  plt.close("all")
