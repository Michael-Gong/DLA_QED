...
#  to_path   = './jpg_log/'
  ...
  for i in range(224,227,1):
          ...
          plt.plot(dist_x0*0.51*1e-3,den0,'-',color='firebrick',linewidth=4,label='w/o RR')
#          plt.plot(dist_x1*0.51*1e-3,den1,'-',linewidth=4,label='Electron w LL RR')
          plt.plot(dist_x2*0.51*1e-3,den2,'-',color='seagreen',linewidth=4,label='with RR')
          ...
          plt.subplots_adjust(top=0.98, bottom=0.14, left=0.14, right=0.95, hspace=0.10, wspace=0.15)
          fig = plt.gcf()
