...
if __name__ == "__main__":
  ...
  for i in range(nsteps):
          width = 100
          kwargs = dict(histtype='stepfilled', alpha=0.3, normed=None, color='r', bins=100, range=(0,4000), weights=ww0[abs(py0[:,0]-100)< 60,i],label='no')
          plt.hist(gg0[abs(py0[:,0]-100)< 60,i], **kwargs)
          kwargs = dict(histtype='stepfilled', alpha=0.3, normed=None, color='b', bins=100, range=(0,4000), weights=ww1[abs(py1[:,0]-100)< 60,i],label='ll')
          plt.hist(gg1[abs(py1[:,0]-100)< 60,i], **kwargs)
          kwargs = dict(histtype='stepfilled', alpha=0.3, normed=None, color='g', bins=100, range=(0,4000), weights=ww2[abs(py2[:,0]-100)< 60,i],label='qe')
          plt.hist(gg2[abs(py2[:,0]-100)< 60,i], **kwargs)
