...
if __name__ == "__main__":
  ...
  ax.scatter(x1[n,:], y1[n,:], c=gg1[n,:], norm=colors.Normalize(vmin=00,vmax=1000), s=10, cmap='rainbow', edgecolors='None', alpha=1,zorder=3)
  ax2.scatter(x1[n,:], y1[n,:], c=gg1[n,:], norm=colors.Normalize(vmin=000,vmax=1000), s=10, cmap='rainbow', edgecolors='None', alpha=1,zorder=3)
...
#  cbar.set_label('$\gamma$',fontdict=font)
  ...
  fig.savefig('./wrap_x_y_no.png',format='png',dpi=160)
  plt.close("all")
