...
for nb0 in grid_b0:
    for np0 in grid_p0:
        ...
        plt.scatter(x[index,:]/2/np.pi, y[index,:]/2/np.pi, c=eta[index,:], s=4, cmap='jet', edgecolors='None')
        #plt.scatter((t[index,:]-x[index,:])/2/np.pi, y_max, c=R_dep[index,:], s=1, cmap='rainbow', edgecolors='None')
        plt.plot(x[index,:]/2/np.pi, y_max[index,:],'--k',linewidth=2.5,label=r'$Reduced\ w=1$')
        plt.plot(x[index,:]/2/np.pi, -y_max[index,:],'--k',linewidth=2.5)
        #plt.legend(loc='upper right')
        ...
        plt.subplot(3,3,6)
        #plt.scatter((t[index,:]-x[index,:])/2/np.pi,gamma[index,:], c=eta[index,:], s=1, cmap='jet', edgecolors='None')
        plt.scatter(x[index,:]/2/np.pi,gamma[index,:], c=eta[index,:], s=1, cmap='jet', edgecolors='None')
        ...
        plt.subplot(3,3,8)
        plt.scatter((t[index,:]-x[index,:])/2/np.pi, px[index,:]/2/np.pi, c=eta[index,:], s=1, cmap='jet', edgecolors='None')
        #plt.scatter((t[index,:]-x[index,:])/2/np.pi, y_max, c=R_dep[index,:], s=1, cmap='rainbow', edgecolors='None')
        #plt.legend(loc='upper right')
        #plt.colorbar()
        cbar=plt.colorbar(ticks=np.linspace(np.min(R_dep[index,:]), np.max(R_dep[index,:]), 5),shrink=1)
        ...
        plt.subplot(3,3,9)
        plt.scatter((t[index,:]-x[index,:])/2/np.pi, py[index,:]/2/np.pi, c=eta[index,:], s=1, cmap='jet', edgecolors='None')
        #plt.scatter((t[index,:]-x[index,:])/2/np.pi, y_max, c=R_dep[index,:], s=1, cmap='rainbow', edgecolors='None')
        #plt.legend(loc='upper right')
        #plt.colorbar()
        cbar=plt.colorbar(ticks=np.linspace(np.min(R_dep[index,:]), np.max(R_dep[index,:]), 5),shrink=1)
