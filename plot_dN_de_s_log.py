...
if __name__ == "__main__":
  ...
  for i in range(nsteps):
          width = 100
          kwargs = dict(histtype='stepfilled', alpha=0.3, normed=None, color='r', bins=100, range=(0,4000), weights=ww0[:,i],label='no')
          plt.hist(gg0[:,i], **kwargs)
          kwargs = dict(histtype='stepfilled', alpha=0.3, normed=None, color='b', bins=100, range=(0,4000), weights=ww1[:,i],label='ll')
          plt.hist(gg1[:,i], **kwargs)
          kwargs = dict(histtype='stepfilled', alpha=0.3, normed=None, color='g', bins=100, range=(0,4000), weights=ww2[:,i],label='qe')
