...
#      plt.subplot()
      plt.scatter(((t0-x0)%1)[:,i], px0[:,i], c=gg0[:,i], norm=colors.Normalize(vmin=0,vmax=2e3), s=10, cmap='rainbow', edgecolors='None', alpha=0.66)
...
#plt.plot(np.linspace(-500,900,1001), 200-np.linspace(-500,900,1001),'-',color='grey',linewidth=3)
 #   plt.legend(loc='upper right')
      ...
      fig.savefig(to_path+'xi_px_'+str(i).zfill(4)+'.png',format='png',dpi=80)
      plt.close("all")
