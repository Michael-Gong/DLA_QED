...
#          kwargs = dict(histtype='stepfilled', alpha=0.3, normed=None, color='b', bins=300, range=(0,600), weights=ww_1/2)
          kwargs = dict(histtype='stepfilled', alpha=0.9, normed=None, color='r', bins=100, range=(0,10000), weights=part_ww[:,i])
          ...
          fig.savefig(to_path+'dN_dErr'+str(i).zfill(4)+'.png',format='png',dpi=80)
          plt.close("all")
